...
<!-- <div>
    ...
    <div class="row">
		...
		<div class="row" style="display:inline; text-align: center;">
			<a href="addbook.php"><button class="btn btn-success col-lg-3 col-md-4 col-sm-11 col-xs-11 button" style="margin-left: 120px;margin-bottom: 5px"><span class="glyphicon glyphicon-plus-sign"></span> Add Book</button></a>
			<a href="addcat.php"><button class="btn btn-success col-lg-3 col-md-4 col-sm-11 col-xs-11 button" style="margin-left: 180px;margin-bottom: 5px"><span class="glyphicon glyphicon-plus-sign"></span> Add Category of Book</button></a>
		</div>
</div>
	...
	<div class="mod modal fade" id="popUpWindow">
        ...
        <ul class="navbar-nav me-auto text-center">
            ...
            <?php
                ...
                // </li>";
                echo "<li class='nav-item'>
                    <a href='bookstable.php?category=$book_categories' class='nav-link text-dark'>$book_categories</a>
                    <br>
                </li>";
                    }
                }
