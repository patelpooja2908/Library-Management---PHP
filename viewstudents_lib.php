...
<div class="container col-lg-11 ">
	<div class="panel panel-default">
		...
		<div class="row">
			<a href="addstudent.php"><button class="btn btn-success col-lg-3 col-md-4 col-sm-11 col-xs-11 button" style="margin-left: 15px;margin-bottom: 5px">Add Student</button></a>
		...
		<table class="table table-bordered">
				...
				<tr> 
					...
					<td>
					<form action="viewstudents_lib.php" method="post">
