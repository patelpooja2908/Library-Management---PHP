...
if (isset($_FILES['postimg'])) {
   ...
   if ($password == $password2) {
      $sql = "INSERT INTO students( roll_no, password, username, email, dept, photo, phoneNumber, name)
 VALUES ('$roll', '$password', '$username', '$email', '$dept', '$filename', '$phone', '$name' ) ";
        ...
        <div class="alert alert-success alert-dismissable">
            ...
            <div class="container">
                <form class="form-horizontal" role="form" action="addstudent.php" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label for="Password" class="col-sm-2 control-label">DEPTERMENT</label>
                        <div class="col-sm-10">
